...
export function PrimaryFeatures() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-rose-600 pb-28 pt-20 sm:py-32"
    >
      {/* <Image
        className="absolute left-1/2 top-1/2 max-w-none tranzinc-x-[-44%] tranzinc-y-[-42%]"
        src={backgroundImage}
        alt=""
        width={2245}
        height={1636}
              ...
              <Tab.Panels className="lg:col-span-7">
                {features.map((feature) => (
                  <Tab.Panel key={feature.title} unmount={false}>
                    ...
                    <div className="mt-10 w-[45rem] overflow-hidden rounded-xl bg-zinc-50 shadow-xl shadow-rose-900/20 sm:w-auto lg:mt-0 lg:w-[67.8125rem]">
                      <Image
                        className="w-full"
                        src={feature.image}
                        alt=""
