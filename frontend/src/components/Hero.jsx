...
export function Hero() {
  ...
  <span className="relative whitespace-nowrap text-rose-600">
    <svg
      aria-hidden="true"
      viewBox="0 0 418 42"
      className="absolute left-0 top-2/3 h-[0.58em] w-full fill-rose-300/70"
  ...
  redefined.
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-zinc-700">
        Seamlessly switch between creative storytelling, legal precision, and research clarity.
      </p>
